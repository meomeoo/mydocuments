...
data = pd.read_csv('data_house.csv').values 
...
x = data[range(1168),0:7]
y = data[range(1168),7].reshape(-1,1)

xtest = data[range(1168,length),0:7]
ytest = data[range(1168,length),7].reshape(-1,1)
